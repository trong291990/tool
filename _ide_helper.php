...
namespace {
	...
	class Twig extends \Barryvdh\TwigBridge\Twig{
		/**
		 * Constructor.
		 * 
		 * Available options:
		 ...
		 * @static 
		 */
		 public static function __construct($loader = null, $options = array()){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::__construct($loader, $options);
		 }
		 ...
		 */
		 public static function display($name, $context = array()){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::display($name, $context);
		 }
		 ...
		 */
		 public static function setLexer($lexer){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::setLexer($lexer);
		 }
		 ...
		 */
		 public static function setParser($parser){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::setParser($parser);
		 }
		 ...
		 */
		 public static function setCompiler($compiler){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::setCompiler($compiler);
		 }
		 ...
		 */
		 public static function setLoader($loader){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::setLoader($loader);
		 }
		 ...
		 */
		 public static function setExtensions($extensions){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::setExtensions($extensions);
		 }
		 ...
		 */
		 public static function addTokenParser($parser){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::addTokenParser($parser);
		 }
		 ...
		 */
		 public static function addNodeVisitor($visitor){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::addNodeVisitor($visitor);
		 }
		 ...
		 */
		 public static function addFilter($name, $filter = null){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::addFilter($name, $filter);
		 }
		 ...
		 */
		 public static function addTest($name, $test = null){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::addTest($name, $test);
		 }
		 ...
		 */
		 public static function addFunction($name, $function = null){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::addFunction($name, $function);
		 }
		 ...
		 */
		 public static function computeAlternatives($name, $items){
			//Method inherited from \Twig_Environment
			 \Twig_Environment::computeAlternatives($name, $items);
		 }
	...
	class Authority extends \Efficiently\AuthorityController\Facades\Authority{
		/**
		 ...
		 * @static 
		 */
		 public static function __construct($currentUser, $dispatcher = null){
			//Method inherited from \Authority\Authority
			 \Authority\Authority::__construct($currentUser, $dispatcher);
		 }
